...
public class AuthController : ControllerBase
{
    ...
    // Note: marked [AllowAnonymous] so clients can post the refresh token even if current access token expired.
    [AllowAnonymous]
    [HttpPost("logout")]
    ...
    //TODO Clean up tokens - delete instead of invalidating?
    // Public endpoint to exchange a refresh token for new access/refresh tokens.
    [AllowAnonymous]
